...
```{r eda categorical variablex, echo=FALSE, fig.width=12, fig.height=2.5}
...
```{r eda continuous variable, echo=FALSE, results='hide'}
...
```{r chi-sq test, echo = FALSE, results='hide'}
...
```{r checking the chi-sq value for each variable, echo=FALSE, results='asis'}
