...
2. For the second question, the response variable (remote ratio) is a categorical variable with 3 levels: 0, 50% and 100%. Thus the multiple linear regression model from first question is not applicable here. In this case, we can use multinomial logistic regression model. 
